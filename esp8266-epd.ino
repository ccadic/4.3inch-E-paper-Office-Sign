...
void draw_text_demo(void)
{
  ...
  epd_disp_string("International Business Corporation", 0, 100);
  epd_disp_string("Location de bureaux et espaces commerciaux", 0, 140);
  ...
  epd_disp_string("Salle disponible jusqu'a 16h30", 0, 300);
  ...
  epd_disp_string("Dr CADIC Philippe", 0, 200);
  epd_udpate();
  delay(3000);
}
